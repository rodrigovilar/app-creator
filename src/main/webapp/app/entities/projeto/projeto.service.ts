...
type EntityResponseType = HttpResponse<IProjeto>;
type EntityArrayResponseType = HttpResponse<IProjeto[]>;

@Injectable({ providedIn: 'root' })
export class ProjetoService {
  public resourceUrl = SERVER_API_URL + 'api/projetos';
  ...
  update(projeto: IProjeto): Observable<EntityResponseType> {
    return this.http.put<IProjeto>(this.resourceUrl, projeto, { observe: 'response' });
  }
