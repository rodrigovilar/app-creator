package io.nanuvem.appcreator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.nanuvem.appcreator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.nanuvem.appcreator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, io.nanuvem.appcreator.domain.Projeto.class.getName() + ".aplicacaos");
